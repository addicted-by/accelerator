...
DEFAULT_HOOKS = {
    ...
    torch.nn.Dropout: neutral_hook,
    torch.nn.Conv1d: conv_linear_hook,
    torch.nn.Conv2d: conv_linear_hook,
    torch.nn.Conv3d: conv_linear_hook,
    torch.nn.Linear: conv_linear_hook,
    torch.nn.ConvTranspose1d: conv_transposed_hook,
    torch.nn.ConvTranspose2d: conv_transposed_hook,
    torch.nn.ConvTranspose3d: conv_transposed_hook,
}