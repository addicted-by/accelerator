...
from accelerator.utilities.distributed_utils import distributed_state
...
class Logger:
    ...
    @property
    def is_hydra_initialized(self) -> bool:
        """Check if Hydra is being used for configuration"""
        return self._hydra_initialized
