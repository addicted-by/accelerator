...
def change_gamma_1120_to_912(model, ckpt_model_dict):
    log.info("===change_gamma_1120_to_912===")
    ...
    if len(diff_ckpt) == 0 and len(diff_state) == 2 and "gamma.p_forward_arr" in diff_state:
