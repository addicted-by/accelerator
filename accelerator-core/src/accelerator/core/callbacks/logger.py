...
class TensorBoardLogger(BaseLoggerCallback):
    def __init__(self, log_dir: str = "./tb_logs", log_interval: int = 100, **kwargs):
...
class MLflowLogger(BaseLoggerCallback):
    def __init__(
        self, tracking_uri: str = "./mlruns", experiment_name: str = "default", log_interval: int = 100, **kwargs
    ):
        super().__init__(**kwargs)
...
class CSVLogger(BaseLoggerCallback):
    def __init__(self, log_dir: str = "./csv_logs", log_interval: int = 100, **kwargs):
        super().__init__(**kwargs)
        self.log_dir = log_dir
        self.log_interval = log_interval
        self.file_path = None
    ...
    def _write_metrics(self, metrics: dict[str, Any], step: int, epoch: int, phase: str):
        ...
        row_data = {"step": step, "epoch": epoch, "phase": phase}
