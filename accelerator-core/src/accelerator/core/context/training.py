...
from accelerator.utilities.base_container import BaseContainer, ComponentContainer, StateContainer
...
class ValidationComponents(ComponentContainer):
    ...
    def _get_component_mapping(self) -> dict[str, Any]:
        return {"val_loop": self.val_loop, "config": self.config}
...
class TestComponents(ComponentContainer):
    ...
    def _get_component_mapping(self) -> dict[str, Any]:
        return {"test_loop": self.test_loop, "config": self.config}
...
class TrainingState(StateContainer):
    ...
    def _get_progression_info(self) -> dict[str, Any]:
        progression = {"epoch": self.current_epoch, "step": self.current_step}
