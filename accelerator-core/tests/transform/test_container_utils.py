...
class TestContainerGetItem:
    ...
    def test_extract_multiple_kwargs(self):
        ...
        getter = ContainerGetItem(kwargs={
            'image': 'per_batch.input.rgb',
            'label': 'per_batch.target.label'
        })
        args, kwargs = getter(context)
    ...
    def test_extract_mixed_args_and_kwargs(self):
        ...
        getter = ContainerGetItem(
            args=['per_batch.input.rgb', 'per_batch.target.label'],
            kwargs={'pca_mat': 'persistent.additional.pca_mat'}
        )
        args, kwargs = getter(context)
    ...
    def test_repr(self):
        ...
        getter = ContainerGetItem(
            args=['per_batch.input.rgb'],
            kwargs={'label': 'per_batch.target.label'}
        )
