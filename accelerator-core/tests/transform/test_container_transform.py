...
class TestContainerUpdateTransformInit:
    ...
    def test_init_minimal_config(self):
        ...
        transform = ContainerUpdateTransform(items="per_step.prediction.output", trans_inputs=["per_batch.input.rgb"])
    ...
    def test_init_with_trans_opt(self):
        ...
        trans_opt = {"type": "DummyTransform", "param1": "value1", "param2": 42}
        ...
        with pytest.raises(KeyError, match="Transform 'DummyTransform' not found"):
            ContainerUpdateTransform(
                items="per_step.prediction.output", trans_inputs=["per_batch.input.rgb"], trans_opt=trans_opt
            )
    ...
    def test_init_trans_inputs_as_list(self):
        ...
        transform = ContainerUpdateTransform(
            items="per_step.prediction.output", trans_inputs=["per_batch.input.rgb", "per_batch.target.label"]
        )

        assert transform.input_getter.args_paths == ["per_batch.input.rgb", "per_batch.target.label"]
    ...
    def test_init_trans_inputs_as_dict_with_args_kwargs(self):
        ...
        trans_inputs = {"args": ["per_batch.input.rgb"], "kwargs": {"pca_mat": "persistent.additional.pca_mat"}}

        transform = ContainerUpdateTransform(items="per_step.prediction.output", trans_inputs=trans_inputs)
    ...
    def test_init_trans_inputs_as_dict_kwargs_only(self):
        ...
        trans_inputs = {"input": "per_batch.input.rgb", "target": "per_batch.target.label"}
    ...
    def test_init_trans_inputs_none(self):
        ...
        transform = ContainerUpdateTransform(items="per_step.prediction.output", trans_inputs=None)
    ...
    def test_init_multiple_output_items(self):
        ...
        transform = ContainerUpdateTransform(
            items=items, trans_inputs=["per_batch.prediction.output", "per_batch.target.label"]
        )
    ...
    def test_init_with_condition(self):
        ...
        transform = ContainerUpdateTransform(
            items="per_step.prediction.output", trans_inputs=["per_batch.input.rgb"], condition=condition
        )
    ...
    def test_init_with_print_in_bool(self):
        ...
        transform = ContainerUpdateTransform(
            items="per_step.prediction.output", trans_inputs=["per_batch.input.rgb"], print_in=True
        )
    ...
    def test_init_with_print_out_dict(self):
        ...
        transform = ContainerUpdateTransform(
            items="per_step.prediction.output", trans_inputs=["per_batch.input.rgb"], print_out=print_config
        )
    ...
    def test_init_with_copy_context(self):
        ...
        transform = ContainerUpdateTransform(
            items="per_step.prediction.output", trans_inputs=["per_batch.input.rgb"], copy_context=True
        )
    ...
    def test_init_without_items(self):
        ...
        transform = ContainerUpdateTransform(trans_inputs=["per_batch.input.rgb"])
    ...
    def test_init_trans_inputs_invalid_type(self):
        ...
        with pytest.raises(ValueError, match="trans_inputs must be a list or dict"):
            ContainerUpdateTransform(
                items="per_step.prediction.output", trans_inputs="invalid_string"  # Should be list or dict
            )
...
class TestContainerCondition:
    ...
    def test_call_equal_operator_true(self):
        ...
        condition = ContainerCondition({"path": "persistent.config.enabled", "operator": "equal", "value": True})
    ...
    def test_call_not_equal_operator(self):
        ...
        condition = ContainerCondition({"path": "persistent.config.mode", "operator": "not_equal", "value": "test"})
    ...
    def test_call_greater_than_operator(self):
        ...
        condition = ContainerCondition({"path": "per_epoch.metrics.accuracy", "operator": "greater_than", "value": 0.9})
    ...
    def test_call_less_than_operator(self):
        ...
        condition = ContainerCondition({"path": "per_step.loss.total", "operator": "less_than", "value": 0.5})
    ...
    def test_call_greater_equal_operator(self):
        ...
        condition = ContainerCondition(
            {"path": "per_epoch.metrics.accuracy", "operator": "greater_equal", "value": 0.9}
        )
    ...
    def test_call_less_equal_operator(self):
        ...
        condition = ContainerCondition({"path": "per_step.loss.total", "operator": "less_equal", "value": 0.5})
    ...
    def test_call_in_operator(self):
        ...
        condition = ContainerCondition(
            {"path": "persistent.config.mode", "operator": "in", "value": ["train", "finetune", "eval"]}
        )
    ...
    def test_call_not_in_operator(self):
        ...
        condition = ContainerCondition(
            {"path": "persistent.config.mode", "operator": "not_in", "value": ["train", "finetune"]}
        )
    ...
    def test_call_path_not_found(self):
        ...
        condition = ContainerCondition({"path": "nonexistent.path", "operator": "equal", "value": True})
    ...
    def test_call_unknown_operator(self):
        ...
        condition = ContainerCondition(
            {"path": "persistent.config.enabled", "operator": "unknown_operator", "value": True}
        )
...
class TestContainerPrinter:
    ...
    def test_call_without_banner(self, capsys):
        ...
        printer = ContainerPrinter("IN", {"paths": ["per_batch.input.rgb"], "banner": False})
        printer(context)
    ...
    def test_call_with_multiple_paths(self, capsys):
        ...
        printer = ContainerPrinter("OUT", {"paths": ["per_batch.input.rgb", "per_step.loss.total"], "banner": False})
        printer(context)
    ...
    def test_call_with_missing_path(self, capsys):
        ...
        printer = ContainerPrinter("IN", {"paths": ["nonexistent.path"], "banner": False})
        printer(context)
...
class TestContainerUpdateTransformCall:
    ...
    def test_call_with_kwargs(self):
        ...
        transform = ContainerUpdateTransform(
            items="per_step.prediction.output",
            trans_inputs={"kwargs": {"value": "per_batch.input.rgb", "mult": "persistent.additional.multiplier"}},
        )
    ...
    def test_call_output_setting_error(self):
        ...
        transform = ContainerUpdateTransform(
            items=["per_step.loss.ce", "per_step.loss.reg"], trans_inputs=["per_batch.input.rgb"]  # Expects 2 outputs
        )
    ...
    def test_call_with_print_in_and_out(self):
        ...
        transform = ContainerUpdateTransform(
            items="per_step.prediction.output", trans_inputs=["per_batch.input.rgb"], print_in=True, print_out=True
        )
