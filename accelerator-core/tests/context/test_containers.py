...
class TestContainerUpdate:
    ...
    def test_update_with_dict(self):
        ...
        container = PerBatchContainer()
        container.update({"input": {"rgb": [1, 2, 3], "depth": [4, 5, 6]}, "target": {"labels": [0, 1, 2]}})
    ...
    def test_update_with_nested_dict(self):
        ...
        container = PerBatchContainer()
        container.update({"additional": {"metadata": {"level1": {"level2": {"level3": "deep_value"}}}}})
    ...
    def test_update_merges_existing_data(self):
        ...
        container.update({"input": {"rgb": [7, 8, 9], "ir": [10, 11, 12]}})
    ...
    def test_update_with_weakref_control(self):
        ...
        container.update({"additional": {"obj1": obj1, "obj2": obj2}}, use_weakref=True)
    ...
    def test_update_with_dict_like_object(self):
        ...
        container = PerBatchContainer()
        source = OrderedDict([("input", {"rgb": [1, 2, 3]}), ("target", {"labels": [0, 1]})])
        container.update(source)
    ...
    def test_update_replaces_non_dict_with_dict(self):
        ...
        container.update({"additional": {"value": {"nested": "data"}}})
    ...
    def test_update_with_list_of_pairs(self):
        ...
        container = PerBatchContainer()
        container.update([("input", {"rgb": [1, 2, 3]}), ("target", {"labels": [0, 1, 2]})])
    ...
    def test_update_with_nested_list_pairs(self):
        ...
        container = PerBatchContainer()
        container.update(
            {"additional": [("key1", "value1"), ("key2", "value2"), ("nested", [("deep_key", "deep_value")])]}
        )
    ...
    def test_update_with_nested_tuple_pairs(self):
        ...
        container = PerBatchContainer()
        container.update({"additional": (("key1", "value1"), ("nested", (("deep_key", "deep_value"),)))})
    ...
    def test_update_preserves_list_values(self):
        ...
        container = PerBatchContainer()
        container.update({"input": {"data": [1, 2, 3, 4, 5]}})
    ...
    def test_update_with_mixed_tensor_and_dict(self):
        ...
        container = PerBatchContainer()
        tensor = torch.tensor([1, 2, 3])
        container.update({"input": tensor, "target": {"labels": [0, 1, 2]}, "additional": {"metadata": "test"}})
